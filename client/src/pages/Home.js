...
function Home() {
    ...
    function search(items) {
        ...
        return items.filter((item) => item.productName.toString().toLowerCase().indexOf(details.toLowerCase()) > -1);
    ...
    return (
        <div>
                        ...
                        search(datas).map((ele, index) => (
                            <Card className='product' sx={{ maxWidth: 345 }} key={index}>
                                ...
                                <CardContent>
                                    ...
                                    <CardActions>
                                        <Button size="small" onClick={() => handleDelete(ele.id)}>Delete</Button>
                                    </CardActions>
                                </CardContent>
                            </Card>
                        ))
            ...
            <section className='reliable'>
                ...
                <div className='info'>
                    <h1>We Provide Highly <span>Reliable & Effective</span> Legal Solutions</h1>
